...
-- 변환 함수
-- TO_CHAR : 날짜 -> 문자, 숫자 -> 문자
select sysdate, to_char(sysdate, 'YYYY.MM.DD AM PM HH HH24 mi ss') from dual;
-- 2020.11.10. 12:00
...
select trunc (sysdate - to_date('2020-01-01','YY-MM-DD')) from dual;

-- 내가 몇일을 살았는지 확인
select trunc (sysdate - to_date('1992-02-07','YY-MM-DD')) from dual;
