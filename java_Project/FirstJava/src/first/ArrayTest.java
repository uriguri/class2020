...
public class ArrayTest {
	...
	public static void main(String[] args) {
		...
		// 배열의 생성 : 변수들의 저장공간을 생성하는 것
		// new 자료형[개수] : 개수 만큼의 변수를 생성하고 묶음으로 만든다.
		arr = new int[3];
		...
		// 로또 번호 추출 프로그램
		// 정수 데이터 1~45 까지 숫자를 저장하는 변수 45개 생성 -> int타입의 배열 선언, 생성
		System.out.println("로또===============================");
		int[] ball = new int[45];
		
		// 각 변수에 1 ~ 45 까지의 숫자를 중복되지 않게 저장
