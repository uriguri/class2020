...
public class ArrayTest2 {
	...
	public static void main(String[] args) {
		...
		// 2차원 배열의 생성 : new 자료형[행의개수][열의개수]
		arr = new int[3][4];
		
		// 2차원 배열의 참조 : 배열이름[행의 index][열의 index] , index는 0부터시 작
		arr[0][0] = 10;
		...
		System.out.println(arr.length); // 2차원 배열 arr의 length 값은 1차원 배열의 개수를 가진다
										// arr length 값은 2차원 배열의 행의 개수다
		System.out.println(arr[0].length); //arr[0] 은 첫번째 1차원배열을 가르키는 주소값을 저장하는 변수이다.
		System.out.println(arr[1].length); //arr[1] 은 두번째 1차원배열을 가르키는 주소값을 저장하는 변수이다.
		System.out.println(arr[2].length); //arr[2] 은 세번째 1차원배열을 가르키는 주소값을 저장하는 변수이다.
...
//		}
		...
		// fore-each 구문 : 배열의 원본 데이터의 수정이 아닌 
		//				    일괄 참조의 목적일때 사용할 수 있다.
		int[] arr4 = {1,2,3,4,5};
