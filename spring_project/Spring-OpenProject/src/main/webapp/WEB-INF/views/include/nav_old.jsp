	...
	<div class="container-fluid">
		...
		<div class="navbar-collapse offcanvas-collapse"
			...
			<ul class="navbar-nav me-auto mb-2 mb-lg-0">
				...
				<li class="nav-item"><a class="nav-link" href="<c:url value="/mypage/mypage1"/>">My page1</a>
				</li>
				<li class="nav-item"><a class="nav-link" href="<c:url value="/mypage/mypage2"/>">My page2</a>
				</li>
				<li class="nav-item"><a class="nav-link" href="<c:url value="/mypage/mypage3"/>">My page3</a>
				</li>
				
				<li class="nav-item"><a class="nav-link" href="<c:url value="/member/list"/>">회원 리스트</a>
				</li>							
			</ul>
		</div>
	</div>
